# Vision theme for Hugo

![Latest Release](https://img.shields.io/github/tag/apvarun/vision-hugo-theme.svg)
![Vision hugo theme](https://img.shields.io/github/license/apvarun/vision-hugo-theme)
![Hugo generator](https://img.shields.io/badge/generator-hugo-brightgreen)

Vision is a clean and fast blog theme for your Hugo site.

![Vision Icon](https://github.com/apvarun/vision-hugo-theme/raw/main/images/vision-logo.png)
...
![Preview](https://github.com/apvarun/vision-hugo-theme/raw/main/images/screenshot.png)

➡️ [DEMO](https://vision.vercel.app/)
...
```sh
git clone https://github.com/apvarun/vision-hugo-theme.git themes/vision
```

Alternatively, you can include this repository as a [git submodule](https://git-scm.com/docs/gitsubmodules). This makes it easier to update this theme if you have your Hugo site in git as well:

```sh
git submodule add https://github.com/apvarun/vision-hugo-theme.git themes/vision
```

## Preview the theme with example content

Vision theme ships with an fully configured example site. For a quick preview:

Copy the `package.json` file from `themes/vision` folder to your hugo website root folder, and run `npm install`.

```sh
cd themes/vision/exampleSite/
...
4. Set `theme = 'vision'` in config.toml
...
Menu in Vision theme is pre-set to have all section names. You can include custom links in header using the `menu.main` option config.toml.
...
[![Pagespeed Insights Performance](https://github.com/apvarun/vision-hugo-theme/raw/main/images/pagespeed-performance.png)](https://developers.google.com/speed/pagespeed/insights/?url=https%3A%2F%2Fvision.vercel.app&tab=mobile)

## Issues

If you have a question, please [open an issue](https://github.com/apvarun/vision-hugo-theme/issues) for help and to help those who come after you. The more information you can provide, the better!
